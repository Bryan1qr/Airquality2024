...
faceta <- function(lista){
  ...
  df1 %>% 
    mutate(dia1 = case_when(dia1 == semana[1] ~ "Semana 1",
                            ...
                            dia1 == semana[4] ~ "Semana 4",
                            dia1 == semana[5] ~ "Semana 5",
                            dia1 == semana[6] ~ "Semana 6",
                            dia1 == NA ~ NA),
           ...
           dia2 = fct_relevel(
             dia2, "Domingo", "Lunes","Martes", "Miércoles",
    ...
    scale_fill_manual(values = c("#1B9E77", "#D95F02", "#7570B3", "#E7298A", "#66A61E", "gray")) +
    scale_color_manual(values = c("#1B9E77", "#D95F02", "#7570B3", "#E7298A", "#66A61E", "gray")) +
