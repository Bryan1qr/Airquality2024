...
knitr::include_graphics("mapas/output_2.png", dpi = 350)
```
...
En la figura 6 se aprecia que la representación polar de 4 parámetros de calidad de aire de interés $PM_{10}$, $PM_{2.5}$, $NO_2$ y $O_3$. En el caso del parámetro $PM_{10}$ este muestra mayores concentraciones con mayores niveles de velocidad de viento por regiones que ocupan el oeste y el suroeste, en el caso del $PM_{2.5}$ los mayores concentraciones se encuentran donde los niveles de velocidad del viento son menores, estas concentraciones se situan hacia el suroeste, sur y sureste. Las mayores concentraciones de $NO_2$ se presentan con valores reducidos de velocidad de viento, hacia todas las direcciones de viento del gráfico. Los valores de $O_3$ se presentan con valores altos de velocidad de viento con mayor predominancia hacia el noroeste, oeste y hacia el suroeste.
...
knitr::include_graphics("polares/polares_vigil.png", dpi = 400)
```
...
-   En cuanto a los parámetros meteorológicos se destaca la predominancia del viento oeste (270°) y el valor medio de la velocidad del viento en `r a` m/s.
