...
knitr::include_graphics("mapas/output_1.png", dpi = 350)
```
...
-   El Índice de Calidad de Aire utilizado para determinar la calidad de aire en la zona de estudio muestra que durante los dias evaluados presentan las categorías de buenos en la mayoría de casos (a excepción del parámetro $PM_{2.5}$, donde la categoría de moderado se observó en todos los dias evaluados.
